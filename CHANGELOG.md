...
- 44bdd528 feat: set filter and adjust card back preview  (#162)
- 5c6e74a8 chore: bump version to 0.0.2 (#160)
...
- 95bb7971 fix: filter bar settings stay the same when navigating between cards# Changelog

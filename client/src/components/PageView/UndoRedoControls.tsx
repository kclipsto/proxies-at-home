...
export function UndoRedoControls() {
    ...
    const buttonBaseClass = "p-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg text-gray-600 dark:text-gray-400 disabled:opacity-40 disabled:cursor-not-allowed transition-transform duration-75 active:translate-y-[2px] disabled:active:translate-y-0";

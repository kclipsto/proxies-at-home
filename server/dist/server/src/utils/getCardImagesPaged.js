 ...
 */
export async function getImagesForCardInfo(cardInfo, unique = "art", language = "en", fallbackToEnglish = true) {
 ...
 */
export async function getCardsWithImagesForCardInfo(cardInfo, unique = "art", language = "en", fallbackToEnglish = true) {
    const { name, set, number } = cardInfo || {};
    const executeStrategy = (queryTemplate) => {
 ...
 */
export async function getCardDataForCardInfo(cardInfo, language = "en", fallbackToEnglish = true) {
    const { name, set, number } = cardInfo || {};
    if (!name)
        return null;
    const executeStrategy = (queryTemplate) => {
...
export async function getScryfallPngImagesForCard(cardName, unique = "art", language = "en", fallbackToEnglish = true) {
...
export async function getScryfallPngImagesForCardPrints(name, language = "en", fallbackToEnglish = true) {
